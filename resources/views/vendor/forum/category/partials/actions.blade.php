...
<button type="button" class="btn btn-theme small" data-toggle="modal" data-target="#categoryActions">
    <span>
        Actions
    </span>
</button>
...
@push('modal_content')
    ...
    <form action="{{ Forum::route('category.update', $category) }}" method="POST" data-actions-form>
        ...
        <div class="modal fade" id="categoryActions" tabindex="-1" role="dialog" aria-labelledby="categoryActionsLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <h4 class="modal-title" id="categoryActionsLabel">{{ trans('forum::categories.actions') }}</h4>
                    </div>
