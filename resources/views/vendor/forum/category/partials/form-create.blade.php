<form action="{{ Forum::route('category.store') }}" method="POST">
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            ...
            <a href="#form-create" data-toggle="collapse" data-target=".collapse.create-category">{{ trans('forum::categories.create') }}</a>
        </div>
        <div class="collapse create-category" id="form-create">
